...
public class IPPoolUtil {
    public static void main(String[] args)
    {
       ...
       System.out.println(getPoolMax( 20));
         
        System.out.println(getEndIP("192.168.1.12",20).getStartIP());
         
        System.out.println(getEndIP("192.168.1.12",20).getEndIP());
    }
    /**
     * 根据起始IP地址和子网掩码计算终止IP
     */
    public static String getStartIPString(String StartIP,int netmask)
    {
        return getEndIP(StartIP,getMask(netmask)).getStartIP();
    }
    
    /* 根据起始IP地址和子网掩码计算终止IP
    */
   public static String getEndIPString(String StartIP,int netmask)
   {
       return getEndIP(StartIP,getMask(netmask)).getEndIP();
   }
