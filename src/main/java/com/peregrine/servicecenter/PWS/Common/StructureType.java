...
public class StructureType  implements java.io.Serializable {
    ...
    /**
     * Gets the type value for this StructureType.
     * 
     * @return type
     */
    ...
    /**
     * Sets the type value for this StructureType.
     * 
     * @param type
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS/Common", "StructureType"));
